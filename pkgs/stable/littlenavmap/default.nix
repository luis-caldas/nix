...
let
  ...
  customMarble = plasma5Packages.marble.overrideAttrs (old: {
...
in stdenv.mkDerivation rec {
  ...
  prePatch = ''
    cp desktop/Little\ Navmap.desktop desktop/littlenavmap.desktop
  '';
  ...
  installPhase = ''
    ...
    cd ..
    mv resources/icons/littlenavmap.png $out/share/icons/hicolor/32x32/apps/.
